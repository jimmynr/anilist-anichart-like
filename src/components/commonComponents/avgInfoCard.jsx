    ...
    return <div className="w-full mt-3">
        ...
        >
            ...
            <div className="flex flex-col md:flex-row md:gap-x-4 px-4 w-full">
                <div className="flex flex-col gap-y-2 md:gap-y-4 w-full md:w-1/2">
                ...
                <div className="flex items-center flex-wrap md:ml-4 mt-2 md:mt-0 font-semibold text-sm w-full md:w-1/2 md:text-center">
                    {
