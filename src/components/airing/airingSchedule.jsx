...
import { fetchAiringNextWeek } from "../../anilist-api/api"
...
const AiringSchedule = () => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const dailyAiring = filteredResult.map(airing => {
                return {
                    ...airing
                    , date: new Date(airing.airingAt*1000).toLocaleString("en-EN", {
                        weekday: "long",
                        year: "numeric",
                        month: "long",
                        day: "numeric"
    ...
    const displayMedias = (airings, title) => {
        ...
        return <div className="mt-10">
            ...
            <div className="flex flex-wrap justify-start">
                { 
                    airings.map((airing, index) => (<CardsView key={index} media={airing.media} airingInfo={{
