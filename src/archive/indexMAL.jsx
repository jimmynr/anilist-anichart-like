...
import { fetchStudiosFromCSV, getAllMalStudios } from '../../myanimelist-api/constants'
                        ...
                        >
                            <div className="relative">
                                <input
                                    ...
                                    className="text-[#6e859e] bg-white pl-2 pr-10 rounded-sm h-8 mb-2 lg:mb-0"
                                    value={keyword}
                                    onChange={e => setKeyword(e.target.value)}
                                />
                                <IoIosClose
                                    className="text-xl text-[#6e859e] absolute top-1/2 -translate-y-1/2 right-1
